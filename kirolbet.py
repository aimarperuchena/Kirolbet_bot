...
def selectMarket(market, sport_id):
    ...
    try:
        ...
        mycursor.execute(sql, (sport_id, market))
...
def insertGame(sport_id, league_id, game, date, times):
    ...
    try:
        ...
        val = (game, date, times, sport_id, league_id)
        mycursor.execute(sql, val)  
        mydb.commit() 
        row_id=mycursor.lastrowid
    except Exception as e:
...
def updateGame(date, times, game_id):
    try:
        ...
        mycursor.execute(sql, (date, times, game_id))
        mydb.commit()
        sql = "UPDATE game set date = %s, time=%s where id=%s"
        result = mycursor.fetchone()
    except Exception as e: 
...
def selectGame(sport_id, league_id, game, date, times):
    ...
    try:
        ...
        mycursor.execute(sql, (sport_id, league_id, game))
        result = mycursor.fetchone()
        if result == None:
...
def insertOdd(game_bet_id, des, odd):
    ...
    try:
        ...
        mycursor.execute(sql, (int(game_bet_id), des, odd))
        mydb.commit()
    except Exception as e:
        print('INSERT ODD')
        print(e)
...
def selectLeague(sport_id, des):
    ...
    try:
        ...
        mycursor.execute(sql, (des, sport_id))
        result = mycursor.fetchone()
        if result == None:
